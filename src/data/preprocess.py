    ...
    def preprocess_dataset(self, metadata_path, image_dir):
        ...
        for split_name, (df, output_dir, is_training) in splits.items():
            ...
            for idx, row in tqdm(df.iterrows(), total=len(df), desc=f"Processing {split_name} set"):
                image_path = Path(image_dir) / row['Image Index']
                ...
                if processed_image is not None:
                    ...
                    output_path = output_dir / f"processed_{row['Image Index']}"
...
if __name__ == "__main__":
    ...
    metadata_path = "../../data/Data_Entry_2017.csv"  # Update with actual path
    image_dir = "../../data/images"  # Update with actual path
